...
/**
 * 此类引用了https://blog.csdn.net/weixin_33704591/article/details/92070894
 * 和https://blog.csdn.net/weixin_38405253/article/details/90375043的开源代码
 */
...
public class ShiroSession extends DefaultWebSessionManager {
    ...
    public ShiroSession() {
        super();
        //设置 shiro session 失效时间，默认为30分钟，这里现在设置为10小时
        setGlobalSessionTimeout(MILLIS_PER_HOUR* 10);
    }
    /**
    ...
    protected Serializable getSessionId(ServletRequest request, ServletResponse response) {
        ...
        if (StringUtils.isEmpty(sessionId)){
            ...
            System.out.println("请求头中如果有 authToken, 则其值为sessionId");
